...
interface PolarLineRadarChartProps {
...
export const PolarLineRadarChart: React.FC<PolarLineRadarChartProps> = ({
  data,
  width = 400,
  height = 400,
  className,
    ...
    >
      ...
      <g ref={ref}>
        ...
        <motion.path
          d={linePath}
          fill="none"
          stroke="url(#polarLineRadarGradient)"
          strokeWidth="3"
