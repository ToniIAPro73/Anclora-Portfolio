...
interface PolarCombinedLineRadarChartProps {
...
export const PolarCombinedLineRadarChart: React.FC<
  PolarCombinedLineRadarChartProps
> = ({ data, width = 400, height = 400, className }) => {
  ...
  return (
    ...
    >
      <defs>
        <linearGradient
          id="polarCombinedLineRadarGradient"
          x1="0%"
          y1="0%"
          x2="100%"
          y2="0%"
      ...
      <g ref={ref}>
        ...
        <motion.path
          d={linePath}
          fill="none"
          stroke="url(#polarCombinedLineRadarGradient)"
          strokeWidth="3"
          filter="url(#polarCombinedLineGlow)"
