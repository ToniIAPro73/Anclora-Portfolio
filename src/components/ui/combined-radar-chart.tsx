...
interface CombinedRadarChartProps {
...
export const CombinedRadarChart: React.FC<CombinedRadarChartProps> = ({
  data,
  width = 400,
  height = 400,
  className,
    ...
    >
      ...
      <g ref={ref}>
        ...
        <motion.polygon
          ...
          fill="url(#combinedRadarAreaGradient)"
          stroke="url(#combinedRadarLineGradient)"
          strokeWidth="2"
