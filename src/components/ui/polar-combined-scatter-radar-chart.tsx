...
interface PolarCombinedScatterRadarChartProps {
...
export const PolarCombinedScatterRadarChart: React.FC<
  PolarCombinedScatterRadarChartProps
> = ({ data, width = 400, height = 400, className }) => {
  ...
  return (
    ...
    >
      <defs>
        <linearGradient
          id="polarCombinedScatterRadarGradient"
          x1="0%"
          y1="0%"
          x2="100%"
          y2="0%"
      ...
      <g ref={ref}>
          ...
          return (
            <g key={index}>
              ...
              <motion.circle
                ...
                strokeWidth="1"
                strokeOpacity="0.3"
                filter="url(#polarCombinedScatterGlow)"
        ...
        {data.map((item, index) => {
          ...
          const currentPoint = getPoint(currentAngle, item.value);
          const nextPoint = getPoint(nextAngle, data[index + 1].value);
