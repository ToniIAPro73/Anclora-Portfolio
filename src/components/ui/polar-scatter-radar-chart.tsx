...
interface PolarScatterRadarChartProps {
...
export const PolarScatterRadarChart: React.FC<PolarScatterRadarChartProps> = ({
  data,
  width = 400,
  height = 400,
  className,
