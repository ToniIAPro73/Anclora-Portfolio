...
| `anclora-syncxml` _(añadido 2026-08)_    | `syncxml_`       | `syncxml_favicon.ico`           |
...
| Premium        | Impulso, Data Lab, Talent _(pausado)_, Synergi, Command Ctr, SyncXML | Naranja, verde, azul, púrpura, azul/violeta y dorado apagado — 6 hues, con una colisión exacta preexistente (Data Lab/EnergyScan, no forman parte de la misma vista) y una separación estrecha (Impulso/SyncXML, 16°)                                                                                                                           |
