...
- `logo-anclora-private-estates-header.png` — variante del logo sin sufijo "exp", archivada al
  volver a la versión `-exp` (`public/logo-anclora-private-estates-exp.png`) como logo activo.
