...
interface PolarAreaRadarChartProps {
...
export const PolarAreaRadarChart: React.FC<PolarAreaRadarChartProps> = ({
  data,
  width = 400,
  height = 400,
  className,
  ...
  const getPieSlicePath = (index: number) => {
    ...
    const halfWidth = ((2 * Math.PI) / data.length) * 0.5;
    ...
    >
      ...
      <g ref={ref}>
        ...
        {data.map((item, index) => {
          ...
          const slicePath = getPieSlicePath(index);
          ...
          return (
            <g key={index}>
              ...
              <motion.path
                d={slicePath}
                fill="url(#polarAreaRadarGradient)"
                stroke="#FAF9F6"
                strokeWidth="1"
              ...
              <motion.path
                d={slicePath}
                fill={color}
                stroke="url(#polarAreaRadarLineGradient)"
                strokeWidth="2"
                initial={{ opacity: 0, scale: 0 }}
                animate={
