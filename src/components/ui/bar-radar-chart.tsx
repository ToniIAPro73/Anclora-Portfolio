...
export const BarRadarChart: React.FC<BarRadarChartProps> = ({
  data,
  width = 400,
  height = 400,
  className,
        ...
        {data.map((item, index) => {
          ...
          return (
            <g key={index}>
              ...
              <motion.path
                d={barPath}
                fill="url(#barRadarInnerGradient)"
                stroke="#FAF9F6"
                strokeWidth="1"
