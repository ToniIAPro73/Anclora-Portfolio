...
interface PolarCombinedBarRadarChartProps {
...
export const PolarCombinedBarRadarChart: React.FC<
  PolarCombinedBarRadarChartProps
> = ({ data, width = 400, height = 400, className }) => {
  ...
  return (
    ...
    >
      <defs>
        <linearGradient
          id="polarCombinedBarRadarGradient"
          x1="0%"
          y1="0%"
          x2="100%"
          y2="0%"
        ...
        <linearGradient
          id="polarCombinedBarRadarInnerGradient"
          x1="0%"
          y1="0%"
          x2="100%"
          y2="100%"
        ...
        {data.map((item, index) => {
          ...
          return (
            <g key={index}>
              ...
              <motion.path
                d={barPath}
                fill="url(#polarCombinedBarRadarInnerGradient)"
                stroke="#FAF9F6"
                strokeWidth="1"
