...
interface PolarCombinedAreaRadarChartProps {
...
export const PolarCombinedAreaRadarChart: React.FC<
  PolarCombinedAreaRadarChartProps
> = ({ data, width = 400, height = 400, className }) => {
  ...
  return (
    ...
    >
      <defs>
        <linearGradient
          id="polarCombinedAreaRadarAreaGradient"
          x1="0%"
          y1="0%"
          x2="100%"
          y2="100%"
        ...
        <linearGradient
          id="polarCombinedAreaRadarLineGradient"
          x1="0%"
          y1="0%"
          x2="100%"
          y2="0%"
      ...
      <g ref={ref}>
        ...
        <motion.polygon
          ...
          fill="url(#polarCombinedAreaRadarAreaGradient)"
          stroke="url(#polarCombinedAreaRadarLineGradient)"
          strokeWidth="2"
        ...
        <motion.path
          ...
          stroke="url(#polarCombinedAreaRadarLineGradient)"
          strokeWidth="3"
          filter="url(#polarCombinedAreaGlow)"
