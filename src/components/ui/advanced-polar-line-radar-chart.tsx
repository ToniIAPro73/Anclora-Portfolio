...
interface AdvancedPolarLineRadarChartProps {
...
export const AdvancedPolarLineRadarChart: React.FC<
  AdvancedPolarLineRadarChartProps
> = ({ data, width = 400, height = 400, className }) => {
  ...
  return (
    ...
    >
      <defs>
        <linearGradient
          id="advancedPolarLineRadarGradient"
          x1="0%"
          y1="0%"
          x2="100%"
          y2="0%"
      ...
      <g ref={ref}>
        ...
        <motion.path
          d={linePath}
          fill="none"
          stroke="url(#advancedPolarLineRadarGradient)"
          strokeWidth="3"
          filter="url(#advancedPolarLineGlow)"
