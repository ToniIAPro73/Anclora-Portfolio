...
interface AdvancedBarRadarChartProps {
...
export const AdvancedBarRadarChart: React.FC<AdvancedBarRadarChartProps> = ({
  data,
  width = 400,
  height = 400,
  className,
  ...
  return (
    ...
    >
      <defs>
        ...
        <linearGradient
          id="advancedBarRadarInnerGradient"
          x1="0%"
          y1="0%"
          x2="100%"
          y2="100%"
        ...
        {data.map((item, index) => {
          ...
          return (
            <g key={index}>
              ...
              <motion.path
                d={barPath}
                fill="url(#advancedBarRadarInnerGradient)"
                stroke="#FAF9F6"
                strokeWidth="1"
              ...
              <motion.path
                ...
                stroke="#C5A059"
                strokeWidth="2"
                filter="url(#advancedBarRadarGlow)"
                initial={{ opacity: 0, scale: 0, rotate: 0 }}
                animate={
                  isInView
