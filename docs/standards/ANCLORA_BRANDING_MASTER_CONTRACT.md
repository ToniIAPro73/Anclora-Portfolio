...
- `anclora-data-lab`
- `anclora-energyscan`
- `anclora-syncxml` _(añadido 2026-08, verificado, estado `pre-mvp`)_
...
| Premium                                              | `anclora-impulso`, `anclora-talent` _(pausado)_, `anclora-data-lab`, `anclora-energyscan`, `anclora-synergi`, `anclora-command-center`, `anclora-syncxml` | Cobre rosado                             | DM Sans                  | Productos de valor añadido.                                                                                                              |
