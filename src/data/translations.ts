...
export const translations = {
  es: {
    ...
    footer: {
      ...
      brandStatement: "Anclora Private Estates es una marca comercial operada bajo licencia exclusiva por Anclora Group.",
  ...
  en: {
    ...
    footer: {
      ...
      brandStatement: "Anclora Private Estates is a commercial brand operated under exclusive license by Anclora Group.",
